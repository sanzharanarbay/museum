            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('users.index') }}">Manage Users</a></li>
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('roles.index') }}">Manage Roles</a></li>
                        <li><i class="fa fa-bars"></i><a href="{{ route('permissions.index') }}">Manage Permissions</a></li>
