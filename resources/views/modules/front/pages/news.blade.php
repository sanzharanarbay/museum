            ...
            <div class="row">
                <div class="col-lg-8 post-list blog-post-list">
                    <div class="single-post">
                        <img class="img-fluid" src="{{'frontend/assets/img/blog/p1.jpg'}}" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="{{'frontend/assets/img/blog/p2.jpg'}}" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="{{'frontend/assets/img/blog/p3.jpg'}}" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="{{'frontend/assets/img/blog/p4.jpg'}}" alt="">
                        <ul class="tags">
                            <li><a href="#">Art, </a></li>
                            <li><a href="#">Technology, </a></li>
                            <li><a href="#">Fashion</a></li>
                ...
                <div class="col-lg-4 sidebar">
                    ...
                    <div class="single-widget protfolio-widget">
                        <img src="{{'frontend/assets/img/blog/user2.jpg'}}" alt="">
                        ...
                        <div class="blog-list ">
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="{{'frontend/assets/img/blog/r1.jpg'}}" alt="">
                                </div>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="{{'frontend/assets/img/blog/r2.jpg'}}" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="{{'frontend/assets/img/blog/r3.jpg'}}" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
                            ...
                            <div class="single-recent-post d-flex flex-row">
                                <div class="recent-thumb">
                                    <img class="img-fluid" src="{{'frontend/assets/img/blog/r4.jpg'}}" alt="">
                                </div>
                                <div class="recent-details">
                                    <a href="blog-single.html">
                                        <h4>
